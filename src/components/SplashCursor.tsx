...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    function compileShader(glContext: any, type: number, source: string, keywords?: string[]) {
      source = addKeywords(source, keywords);
      const shader = glContext.createShader(type);
      glContext.shaderSource(shader, source);
      glContext.compileShader(shader);
      if (!glContext.getShaderParameter(shader, glContext.COMPILE_STATUS)) console.trace(glContext.getShaderInfoLog(shader));
      return shader;
    }
