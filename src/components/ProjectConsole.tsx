...
export default function ProjectConsole({ project, slug }: { project: Project; slug: string }) {
    ...
    <div className={styles.shell}>
      ...
      <div className={styles.body}>
        ...
        <main className={styles.panel} key={view}>
          ...
          {view === "stack" && <Stack project={project} slug={slug} />}
...
function Stack({ project, slug }: { project: Project; slug: string }) {
  ...
  return (
    <div className={styles.view}>
      ...
      <div className={styles.diagramFrame}>
        <ArchitectureDiagram slug={slug} className={styles.diagram} />
      </div>
    </div>
  )
}
